var simpleAlert = function (opts) {
    ...
    var $simpleAlertBodyClose = $('<img class="simpleAlertBodyClose" src="static/image/close.png" height="14" width="14"/>');
    var $simpleAlertBodyContent = $('<p id="simpleAlertBodyContent" class="simpleAlertBodyContent">' + option.content + '</p>');
                ...
                switch (i) {
                    ...
                    case 1:
                        ...
                        if (key == "点我复制") {
                        	// 复制内容到剪切板
                        	$btn.attr("id", "copyBtn");
                        	$btn.attr("data-clipboard-text", opt.content);
